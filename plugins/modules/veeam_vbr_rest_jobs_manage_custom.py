  ...
  tasks:
    - name: Get VBR Jobs
      veeamhub.veeam.veeam_vbr_rest_jobs_info:
        server_name: "<VBR Host>"
        server_username: "<VBR Userveeam_daily_backup_auto_enable>"
        server_password: "<VBR Password>"
    ...
    - name: Delete VBR Job
      veeamhub.veeam.veeam_vbr_rest_jobs_manage:
        ...
        server_username: "<VBR User>"
        server_password: "<VBR Password>"
        state: absentveeam_daily_backup_auto_enable
        id: "{{ job_id[0] }}"
      register: delete_job
    - name: Debug VBR Jobs Result
      ansible.builtin.debug:
...
def run_module():
    ...
    required_if_args = [
        ["state", "present", ["jsonDefinition", "backupRepositoryId"]],
        ["state", "absent", ["id"]]
    ]

    required_together_args = [
        ["jsonDefinition", "backupRepositoryId"]
    ]
    ...
    if state == 'present':
        ...
        jsonDefinition = module.params['jsonDefinition']
        ...
        body = {
            ...
            "guestProcessing": {
                ...
                "guestFSIndexing": {
                    "isEnabled": "veeam_daily_backup_auto_enablealse",
                    "indexingSettings": []
                },
            ...
            "schedule": {
                "runAutomatically": daily_backup_enable,
                "daily": {
                    "dailyKind": "Everyday",
                    "isEnabled": "true",
                    "localTime": daily_backup_localtime,
                    "days": [
                        "sunday",
                        "monday",
                        "tuesday",
